    ...
    return (
        <NestedContainer>
            <InputLabelWrap>
              ...
              <Input onChange={props.onFirstNameChange} type='text' valid={props.validFirstname} placeholder='Type your firstname' />
              {
            ...
            <InputLabelWrap>
              ...
              <Input onChange={props.onLastnameChange} type='text' valid={props.validLastname} placeholder='Type your lastname' />
              {
            ...
            <InputLabelWrap>
              ...
              <Input onChange={props.onEmailChange}  type='text' valid={props.validEmail} placeholder='Type your email' />
              {
            ...
            <InputLabelWrap>
              ...
              <Input onChange={props.onOrganizationChange} type='text' placeholder='Type your organization' />
            </InputLabelWrap>
            <InputLabelWrap>
